...
public class CurrencyService {
    ...
    public CryptoData getCryptoData(String cryptoId) {
        ...
        String url = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids="
                + cryptoId + "&x_cg_demo_api_key=CG-5y78X9y54Ztoo4ZabAyxJEFc";
    ...
    public List<Currency> findByNameContaining(String name) {
        return currencyRepository.findByNameContainingIgnoreCase(name.trim());
    }
